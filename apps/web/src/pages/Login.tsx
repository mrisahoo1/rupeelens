    ...
    <div className="relative mx-auto grid min-h-screen max-w-7xl gap-8 px-5 py-8 lg:grid-cols-[1.1fr_.9fr] lg:px-8">
      <section className="flex min-h-[58vh] flex-col justify-between py-8 lg:min-h-screen lg:py-10">
        <motion.div initial={{opacity:0,y:16}} animate={{opacity:1,y:0}} className="flex items-center gap-3">
          ...
          <div><div className="font-display text-2xl font-black">RupeeLens</div><div className="text-xs uppercase tracking-[.28em] text-emeraldx/80">Spend Intelligence OS</div></div>
        </motion.div>
        <motion.div initial={{opacity:0,y:28}} animate={{opacity:1,y:0}} transition={{delay:.08}} className="max-w-3xl">
          ...
          <h1 className="font-display text-6xl font-black leading-[.92] tracking-tight sm:text-7xl xl:text-8xl">See where your money actually goes.</h1>
